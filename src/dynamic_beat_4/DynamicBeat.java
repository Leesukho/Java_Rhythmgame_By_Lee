...
public class DynamicBeat extends JFrame {
	...
	private Image introBackground = new ImageIcon(Main.class.getResource("../images/introBackground2.jpg")).getImage();
	...
	public void screenDraw(Graphics g) {
		g.drawImage(introBackground, 0, 0, null);// 항상 움직이는 경우 실행 화면
