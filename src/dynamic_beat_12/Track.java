...
public class Track {//해당 곡의 대한 엘범표지,노래 정보 등
	...
	public Track(String titleImage, String startImage, String gameImage, String startMusic, String gameMusic, String titleName) {//생성자
		super();
		this.titleImage = titleImage;
		this.startImage = startImage;
		this.gameImage = gameImage;
