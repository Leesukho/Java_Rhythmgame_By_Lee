...
public class Game extends Thread {//Thread 는 하나의 프로그램에서 실행되는 작은 프로그램
	...
	private Image blueFlareImage;// 노트가 찍힐때 나오는 빛
	private Image JudgeImage;// 노트가 찍힐때 나오는 판단
	...
	public void screenDraw(Graphics2D g){ //게임 실행화면 (노트,곡이름,점수,난이도,키패드)
		...
		g.drawImage(blueFlareImage, 480, 400, null);
		g.drawImage(JudgeImage, 450, 300, null);
		//Y축이 580 이 PinPoint
